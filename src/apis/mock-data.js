...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Manhnqdev MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            title: 'IU hotel deluna',
            description: 'Markdown Syntax (sẽ ở khóa nâng cao nhé)',
            cover: 'https://image.phunuonline.com.vn/news/2019/20190824/fckimage/160327_1-1-231023216.jpg',
      ...
      },
      {
         ...
         * Phía FE sẽ tự tạo ra 1 cái card đặc biệt: Placeholder Cardm, ko liên quan tới backend
         * Card đặc biệt này sẽ đc ẩn ở giao diện UI người dùng.
         * Cấu trúc Id của card này sẽ để unique rất đơn giản, ko cần phải random phức tạp:
         * Quan trọng khi tạo: phải đầy đủ (_id, boardId, columnId) như 1 card bình thường
         * *** Kỹ hơn nữa cách tạo chuẩn ở bước nào sẽ học ở phần tích hợp API Back-end vào dự án (bởi đây là file mock data)
         */
